...
class TestBasicConvertor(unittest.TestCase):
    ...
    def test_can_convert_string(self):
        ...
        # Действие
        result = self.convertor.can_convert(string_obj)
    ...
    def test_can_convert_integer(self):
        ...
        # Действие
        result = self.convertor.can_convert(int_obj)
    ...
    def test_can_convert_float(self):
        ...
        # Действие
        result = self.convertor.can_convert(float_obj)
    ...
    def test_can_convert_boolean(self):
        ...
        # Действие
        result = self.convertor.can_convert(bool_obj)
    ...
    def test_can_convert_none(self):
        ...
        # Действие
        result = self.convertor.can_convert(none_obj)

        # Проверка
        self.assertTrue(result)

    def test_cannot_convert_list(self):
        # Подготовка
        list_obj = [1, 2, 3]

        # Действие
        result = self.convertor.can_convert(list_obj)

        # Проверка
        self.assertFalse(result)

    def test_cannot_convert_dict(self):
        # Подготовка
        dict_obj = {"key": "value"}

        # Действие
        result = self.convertor.can_convert(dict_obj)
